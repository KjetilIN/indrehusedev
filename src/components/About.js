        ...
        <div className="mt-96 bg-mainSH h-full p-4">
            ...
            <div className="flex">
                <div className="bg-white w-[640px] rounded-sm border-b-gray-dark border-2 shadow-card1 hover:shadow-card2 transition-shadow relative left ml-10 h-auto p-6">
                    <h1>Hi 🙌</h1>
                    <p>
                        My name is Kjetil Indrehus. I am a Computer engineer
                        student at NTNT Gjøvik 👨‍💻! <br /> I have a lot of
                        ambition for developing usefull techonolgy, and learning
                        new techonolgy every day! I made this website so you
                        could now what I am currently learning! Feel free to
                        contact me!
                    </p>
                </div>
                ...
                <div className="relative left-96">
                    <div
                        ...
                        data-vanity="kjetil-indrehus"
                        data-version="v1"
                    >
                        <a
                            class="badge-base__link LI-simple-link"
                            href="https://no.linkedin.com/in/kjetil-indrehus?trk=profile-badge"
                        ></a>
                    </div>
                </div>
            </div>
            ...
            <div className="flex">
                <div className="bg-white w-[200px] rounded-sm border-b-gray-dark border-2 shadow-card1 hover:shadow-card2 transition-shadow relative left ml-10 h-auto p-6 my-2 flex-col">
                    <img className="h-[150px] w-[150px]" src="./img/ntnu.png" />
                    <h2 className="relative top-5">
                        <span className="font-bold">Education:</span> Computer
                        engineer (2021-2024)
                    </h2>
                </div>
